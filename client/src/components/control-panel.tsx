...
export function ControlPanel({
  ...
  return (
    <div className={`space-y-4 ${className}`}>
      <div className="rounded-2xl border border-primary/15 bg-primary/5 p-4 shadow-[0_16px_35px_-28px_rgba(15,23,42,0.35)]">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="text-sm font-medium text-foreground">{t("controls.startHereTitle")}</p>
            <p className="mt-1 text-xs text-muted-foreground">
              {showAdvancedByDefault
                ? t("controls.startHereCompleteBody")
                : t("controls.startHereBody")}
            </p>
          </div>
        </div>
      </div>
        ...
        <Card className="p-5" data-onboarding="vpn-toggle">
          <div className="flex items-center justify-between mb-3">
            <Label className="text-[11px] font-semibold text-muted-foreground uppercase tracking-[0.2em] flex items-center gap-1">
              {t("controls.vpn")}
              <InlineInfoTooltip
                label={t("controls.vpnTooltip")}
                content={t("controls.vpnTooltip")}
              />
            </Label>
          </div>
          <div className="flex items-center gap-3">
      ...
      <Collapsible open={isAdvancedOpen} onOpenChange={setIsAdvancedOpen}>
        <Card className="p-5">
          <CollapsibleTrigger asChild>
            <button
              type="button"
              className="flex w-full items-center justify-between gap-4 rounded-2xl text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40"
              data-onboarding="advanced-controls"
            >
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0">
                  <p className="text-sm font-medium text-foreground">
                    {t("controls.advancedTitle")}
                  </p>
                  <p className="mt-1 text-xs text-muted-foreground">
                    {showAdvancedByDefault
                      ? t("controls.advancedReadyBody")
                      : t("controls.advancedBody")}
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-2 shrink-0 text-xs font-medium text-muted-foreground">
                <span>
                  {isAdvancedOpen ? t("controls.hideAdvanced") : t("controls.showAdvanced")}
                </span>
                <ChevronRight
                ...
                <div className="grid grid-cols-1 gap-2">
                  ...
                  >
                    <span className="font-medium">
                      {t("controls.attackerModels.rogueHotspot")}
                    </span>
                  </button>
                  <button
                    type="button"
                  ...
                  >
                    <span className="font-medium">
                      {t("controls.attackerModels.compromisedEndpoint")}
                    </span>
                  </button>
                </div>
              </Card>
